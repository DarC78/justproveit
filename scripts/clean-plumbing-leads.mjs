...
const INPUTS = [
  'leads/Small Plumbing Companies UK - Emails.csv',
  'leads/Small-Plumbing-Companies-UK-DataForSEO.csv',
  'leads/Small-Plumbing-Companies-UK-DataForSEO-Maps.csv',
  'leads/Small-Plumbing-Companies-UK-DataForSEO-Maps-National.csv'
];

const OUTPUT = 'leads/Small-Plumbing-Companies-UK-Master.csv';
const CLEAN_NATIONAL = 'leads/Small-Plumbing-Companies-UK-DataForSEO-Maps-National-Clean.csv';
...
async function main() {
  ...
  const nationalRows = cleanRows(await readRows('leads/Small-Plumbing-Companies-UK-DataForSEO-Maps-National.csv'));
