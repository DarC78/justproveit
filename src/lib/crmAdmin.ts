...
export type CrmSale = {
  ...
  dialerOwnerCallDateUtc?: string | null;
  dialerownerCallDate?: string | null;
  dialerOwnerCallDate?: string | null;
  dialerownerCallTimeUtc?: string | null;
  dialerOwnerCallTimeUtc?: string | null;
  dialerownerAtUtc?: string | null;
  dialerOwnerAtUtc?: string | null;
  dialerFirstCallDateUtc?: string | null;
  dialerfirstCallDateUtc?: string | null;
  dialerFirstCallDate?: string | null;
  dialerfirstCallDate?: string | null;
  dialerFirstCallTimeUtc?: string | null;
  dialerfirstCallTimeUtc?: string | null;
  dialerFirstCallAtUtc?: string | null;
  dialerfirstCallAtUtc?: string | null;
  dialerFirstAtUtc?: string | null;
  dialerfirstAtUtc?: string | null;
  firstDialerCallAtUtc?: string | null;
  firstDialerCallDateUtc?: string | null;
  firstDialerCallDate?: string | null;
  firstDiallerCallAtUtc?: string | null;
  firstDiallerCallDateUtc?: string | null;
  firstCallAtUtc?: string | null;
  firstCallDateUtc?: string | null;
  dialerFirstDate?: string | null;
  dialerlastCallDateUtc?: string | null;
  dialerLastCallDateUtc?: string | null;
  dialerlastCallDate?: string | null;
  dialerLastCallDate?: string | null;
  dialerlastCallTimeUtc?: string | null;
  dialerLastCallTimeUtc?: string | null;
  dialerlastAtUtc?: string | null;
  dialerLastAtUtc?: string | null;
  dialerlastCallAtUtc?: string | null;
  dialerLastCallAtUtc?: string | null;
  lastDialerCallAtUtc?: string | null;
  lastDialerCallDateUtc?: string | null;
  lastDialerCallDate?: string | null;
  lastDiallerCallAtUtc?: string | null;
  lastDiallerCallDateUtc?: string | null;
  lastCallAtUtc?: string | null;
  lastCallDateUtc?: string | null;
  dialerLastDate?: string | null;
};
...
export type CrmAgentReportRow = {
  ...
  eveningPauseBreakdown?: CrmAgentReportPauseBreakdownRow[] | Record<string, number | string | null> | null;
  eveningPausesByType?: CrmAgentReportPauseBreakdownRow[] | Record<string, number | string | null> | null;
...
export function listCrmAgentReport(
  token: string,
  params: Record<string, string | number | boolean | null | undefined>,
) {
