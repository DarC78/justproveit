    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-950">
        ...
        <main className="mx-auto w-full max-w-6xl space-y-8 px-4 py-8">
          <section className="grid items-start gap-8 lg:grid-cols-[minmax(0,0.58fr)_minmax(320px,0.42fr)]">
          ...
          <section className="grid items-start gap-8 lg:grid-cols-[minmax(0,0.58fr)_minmax(320px,0.42fr)]">
            ...
            <section className="self-start rounded-lg border border-emerald-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between gap-3">
